...
y = np.linspace(-5, 5, 50).                         # All o this is jst setting up graph 
X, Y = np.meshgrid(x, y)
...
V4 = doublet_strength * (2 * X * Y) / r_squared**2                      #This is a doublet, which models actual flow around some object check my journal on hackclub to understand this completely
