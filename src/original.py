...
class FlowSimulator:
    ...
    def __init__(self, x_range=(-5, 5), y_range=(-5, 5), grid_points=80):
        ...
        """
                        This is what I found when I was trying to understand what it does
                        ...
                        TO UNDERSTAND DOUBLETS MORE COMPLETELY WATCH ORGANIC CHEMISTY TUTOR
        """

    def on_click(self, event):
        """
        essentially just handles mouse clicks
        """
    ...
    def draw_particles(self):
        '''
            Essentially actually creating particles
        '''
    ...
    def animate(self, frame):
        '''
        Animate is creating the movements for particles
        we use matplotlib.animate for this not sure if there is a better library
        '''
    ...
    def run(self):
        ...
        ofcourse ctrl C to close window
        """
    ...
    """
    *IMPORTANT*   The Current Slider only impacts the first obstacle, I have just added particles to the simulation, no clue if it will work or not.
    """